...
const Cursor = () => {
  ...
  return (
    ...
    <motion.div
      ...
      className="w-16 h-16 rounded-full pointer-events-none fixed  border border-white grid place-items-center"
    >
    ...
    <motion.div
        ...
        className="bg-white fixed pointer-events-none  rounded-full w-4 h-4"
      ></motion.div>
    </div>
